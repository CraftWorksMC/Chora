...
abstract class MediaProvider {
    ...
    abstract suspend fun getAlbumArtistDetail(id: String): MediaItem.AlbumArtist?
    abstract suspend fun getAlbumArtistInfo(id: String, limit: Int? = null): AlbumArtistInfoResponse?
    abstract suspend fun getAlbumArtistList(query: MediaQuery.AlbumArtistListQuery): List<MediaItem.AlbumArtist>
    abstract suspend fun getAlbumArtistListCount(query: MediaQuery.AlbumArtistListQuery): Int
    abstract suspend fun getAlbumDetail(id: String): MediaItem.Album
    abstract suspend fun getAlbumInfo(id: String): AlbumInfo
    abstract suspend fun getAlbumList(query: MediaQuery.AlbumListQuery): List<MediaItem.Album>
    abstract suspend fun getAlbumListCount(query: MediaQuery.AlbumListQuery): Int
    abstract suspend fun getAlbumRadio(albumId: String, count: Int? = null): List<MediaItem.Song>
    abstract suspend fun getArtistList(query: MediaQuery.ArtistListQuery): List<MediaItem.AlbumArtist>
    abstract suspend fun getArtistListCount(query: MediaQuery.ArtistListQuery): Int
    abstract suspend fun getArtistRadio(artistId: String, count: Int? = null): List<MediaItem.Song>
    abstract suspend fun getDownloadUrl(id: String): String
    abstract suspend fun getFolder(query: MediaQuery.FolderQuery): MediaItem.Folder
    abstract suspend fun getGenreList(query: MediaQuery.GenreListQuery): List<MediaItem.Genre>
    ...
    abstract suspend fun getPlaylistDetail(id: String): MediaItem.Playlist
    abstract suspend fun getPlaylistList(query: MediaQuery.PlaylistListQuery): List<MediaItem.Playlist>
    abstract suspend fun getPlaylistListCount(query: MediaQuery.PlaylistListQuery): Int
    abstract suspend fun getPlaylistSongList(id: String): List<MediaItem.Song>
    abstract suspend fun getPlayQueue(): GetQueueResponse
    abstract suspend fun getRandomSongList(query: MediaQuery.RandomSongListQuery): List<MediaItem.Song>
    abstract suspend fun getRoles(): List<String>
    abstract suspend fun getProviderInfo(): ProviderInfo
    abstract suspend fun getSimilarSongs(songId: String, count: Int? = null, musicFolderId: List<String>? = null): List<MediaItem.Song>
    abstract suspend fun getSongDetail(id: String): MediaItem.Song
    abstract suspend fun getSongList(query: MediaQuery.SongListQuery): List<MediaItem.Song>
    ...
    abstract suspend fun getTopSongs(artist: String, artistId: String, limit: Int? = null, type: String? = null): List<MediaItem.Song>
